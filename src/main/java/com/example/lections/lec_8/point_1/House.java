...
public class House {
    ...
    public House(String type, int floorNumber, int residentsNumber, boolean heatingOn) {
      if("Individual".equals(type) || "Skytower".equals(type)) {
          ...
          throw new IllegalArgumentException("sagdahgb");
      }
    }
    ...
    public boolean equals(Object o) {
        ...
        House house = (House) o;
        return floorNumber == house.floorNumber && residentsNumber == house.residentsNumber && heatingOn == house.heatingOn && Objects.equals(type, house.type);
    }
